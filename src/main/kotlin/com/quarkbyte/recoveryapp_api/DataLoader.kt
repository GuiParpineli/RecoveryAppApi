...
//        //save products
        ...
        sinistroRepository.save(
            Sinistro(
                ...
                resolutionDate = Date(),
                value = 2000.0,
                observation = mutableSetOf("Sinistro observacao aleatoria"),
                coverageValue = 20.0,
        ...
        misappropriationRepository.save(
            Misappropriation(
                ...
                observation = mutableSetOf("Vai pagar um dia, quem sabe", "Outra Anotacao"),
        ...
        misappropriationRepository.save(
            Misappropriation(
                ...
                observation = mutableSetOf("Vai pagar um dia, quem sabe"),
